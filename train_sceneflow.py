...
parser.add_argument('--datapath', default="/mnt/9c69d5cd-01cb-4603-b7c6-06d924734d0c/CYJ/dataset/scenflow_finalpass/", help='data path')
...
parser.add_argument('--logdir', default='./checkpoints_64_1/sceneflow/first/', help='the directory to save logs and checkpoints')
